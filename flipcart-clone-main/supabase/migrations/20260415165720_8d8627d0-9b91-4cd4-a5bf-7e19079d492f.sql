...
-- Add user_id to carts (nullable for anonymous users)
ALTER TABLE public.carts ADD COLUMN user_id UUID REFERENCES auth.users(id) ON DELETE SET NULL;

-- Add user_id to orders (nullable for anonymous users)  
